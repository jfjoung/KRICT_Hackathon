...
def train_kneighbors_regression():
    ...
    for fold, (train_idx, val_idx) in enumerate(cv.split(X)):
        ...
        # Pipeline with preprocessor and KNeighborsRegressor model
        pipeline = Pipeline(steps=[
            ('preprocessor', preprocessor),
            ('model', KNeighborsRegressor())  # Use KNeighborsRegressor instead
        ])
        ...
        # Save model
        model_path = os.path.join(model_dir, f'kneighbors_regressor_fold_{fold}.joblib')
